...
version (GNU) {
     ...
     * import gcc.attributes;
     *
     * @alloc_size(1) extern(C) void* malloc(usize size);
     * @alloc_size(3,2) extern(C) void* reallocarray(void *ptr, usize nmemb,
     *                                               usize size);
     * @alloc_size(1,2) void* my_calloc(usize element_size, usize count,
     *                                  bool irrelevant);
     * ---
     */
